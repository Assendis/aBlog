...
<head>
    ...
    <title><?=$this->session->oturum_data["ad+soyad"]?></title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url()?>Admin/Home/"><?=$this->session->oturum_data['ad']; ?> <?=$this->session->oturum_data['soyad']; ?>
                  </a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?=base_url()?>admin/Members/Profil/<?=$this->session->oturum_data['id']; ?>"><i class="fa fa-gear fa-fw"></i> Ayarlar</a>
                        </li>
                        <li class="divider"></li>
